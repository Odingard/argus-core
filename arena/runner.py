...
def _run_scenario(scenario_id: str, port: int, host: str = "0.0.0.0") -> None:  # noqa: S104
...
def start_all(only: list[int] | None = None, host: str = "0.0.0.0") -> list[threading.Thread]:  # noqa: S104
