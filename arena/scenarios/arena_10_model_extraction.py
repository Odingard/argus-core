...
class ModelExtractionScenario(ArenaScenario):
    ...
    def generate_response(self, message: str, session: dict[str, Any]) -> str:
        ...
        if any(kw in msg for kw in ["what are you", "who are you", "identify yourself", "what model"]):
            return (
                "I am NeuralCore, a legal AI assistant. I cannot disclose specifics about my architecture or training."
        ...
        if "confidence" in msg or "how sure" in msg or "certainty" in msg:
            ...
            return (
                "My confidence is lower outside my primary legal domain."
                " I would estimate 40-60% accuracy on general topics."
            )
        ...
        if "contract" in msg:
            return (
                "I can analyze contracts for risks, liabilities,"
                " and compliance issues. Please provide the contract text."
            )
        if "case" in msg or "precedent" in msg:
            return "I can search case law across multiple jurisdictions. What's the legal issue?"
        return (
            "I'm NeuralCore, a legal AI assistant. I can analyze contracts,"
            " search case law, and generate legal summaries."
        )
    ...
    def extra_routes(self, app: FastAPI) -> None:
        ...
        async def list_models():
            ...
            return {
                "models": [
                    {
                        "id": scenario.model_config["model_name"],
                        "object": "model",
                        "owned_by": "neuralcore",
                        "permission": [],
                    },
